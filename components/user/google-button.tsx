...
export const GoogleLogin: FC = () => {
  ...
  return (
    <>
      <div id="googleButotn" className='btn ml-0 mt-3 border-2 dark:border-none dark:bg-white p-2 primary-dark flex flex-row justify-center w-full h-10 items-center'>
